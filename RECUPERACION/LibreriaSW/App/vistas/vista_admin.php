...
if(isset($_POST["btnDetalles"]))
{
    ...
    $url = DIR_SERV . "/obtener_libro/".$_POST["btnDetalles"]."";
    ...
    $datos_libro = $obj["libros"];

    echo "<h1>Detalles Libro</h1>";
    echo "<p><strong>Referencia: </strong>".$datos_libro["referencia"]."</p>";
    echo "<p><strong>Titulo: </strong>".$datos_libro["titulo"]."</p>";
    echo "<p><strong>Autor: </strong>".$datos_libro["autor"]."</p>";
    echo "<p><strong>Descripcion: </strong>".$datos_libro["descripcion"]."</p>";
    echo "<p><strong>Precio: </strong>".$datos_libro["precio"]."</p>";
    echo "<p><strong>Portada: </strong> <img src='".$datos_libro["portada"]."' /></p>";
...
<body>
    ...
    foreach ($obj->libros as $tupla) {
        ...
        echo "<td><form action='gest_libros.php' method='post'><button class='enlace' type='submit' value='".$tupla->referencia."' name='btnDetalles'>".$tupla->autor."</button></form></td>";
