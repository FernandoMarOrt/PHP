...
{
    session_destroy();
    die(error_page("Gestion de Guardias","<h1>Gestión de Guardias</h1><p>Error consumiendo el servicio: ".$url."</p>"));
}
if(isset($obj->error))
{
    consumir_servicios_REST(DIR_SERV."/salir","POST",$datos);
    session_destroy();
    die(error_page("Gestion de Guardias","<h1>Gestión de Guardias</h1><p>".$obj->error."</p>"));
}
